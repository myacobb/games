...
def draw(canvas):
    ...
    #ball collison check on top and bottom walls
    ...
    print("BALL_RADIUS: {} PAD_WIDTH: {} HALF_PAD_HEIGHT: {} BALL_POS[1]: {} PADDLE1_POS[1]: {}".format(BALL_RADIUS, PAD_WIDTH, HALF_PAD_HEIGHT, ball_pos[1], paddle1_pos[1]))
    """ the following if block is fixed, now you fix the next ;)"""
